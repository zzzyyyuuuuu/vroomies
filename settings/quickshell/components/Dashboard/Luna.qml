            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    function generateDays() {
                        var days = []
                        var first = new Date(displayDate.getFullYear(), displayDate.getMonth(), 1).getDay()
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    id: calPrevMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                                    onClicked: {
                                        var p = calRect
                                        p.displayDate = new Date(p.displayDate.getFullYear(), p.displayDate.getMonth() - 1, 1)
                                        p.reload()
                                    }
                                }
                            }
                            ...
                            Text {
                                ...
                                text: {
                                    var p = calRect
                                    return p.displayDate.toLocaleDateString(Qt.locale(), "MMMM yyyy")
                                }
                                color: dashboard.fg
                            ...
                            Rectangle {
                                ...
                                Text { anchors.centerIn: parent; text: ""; color: dashboard.accent; font.family: dashboard.fontFam; font.pixelSize: 11 }
                                MouseArea {
                                    id: calNextMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                                    onClicked: {
                                        var p = calRect
                                        p.displayDate = new Date(p.displayDate.getFullYear(), p.displayDate.getMonth() + 1, 1)
                                        p.reload()
                            ...
                            Rectangle {
                                ...
                                Rectangle {
                                    ...
                                    Text {
                                        id: dndTip
                                        anchors.centerIn: parent
                                        text: dashboard.doNotDisturb ? "DND Açık" : "Rahatsız Etme"
                                        color: "#ffffff"
                                        font.pixelSize: 9
                                        font.family: dashboard.fontFam
                                    }
